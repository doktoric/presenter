...
public class Component {
	...
	public static long countComponents() {
	...
	public static Component findComponent(Long id) {
        if (id == null) return null;
        return entityManager().find(Component.class, id);
    }

	public static List<Component> findComponentEntries(int firstResult, int maxResults) {
	...
	public ElementType getStatus() {
        return this.status;
    }

	public void setStatus(ElementType status) {
        this.status = status;
    }
}
